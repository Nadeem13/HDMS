...
public class ChefHomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Home Delivery Micro Services");
    ...
    private void chefDishes() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("ItemSupplyDetails").child(State).child(City).child(Sub).child(useridd);
