...
public class ChefOrderTobePrepared extends AppCompatActivity {
    ...
    private void cheforderstobePrepare() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("ShopkeeperWaitingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        DatabaseReference data = FirebaseDatabase.getInstance().getReference("ShopkeeperWaitingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(snapshot.getKey()).child("OtherInformation");
