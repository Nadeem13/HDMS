...
public class ChefPreparedOrderViewAdapter extends RecyclerView.Adapter<ChefPreparedOrderViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.dishname.setText(chefFinalOrders.getItemName());
        holder.price.setText("Price: ₹ " + chefFinalOrders.getItemPrice());
        holder.quantity.setText("× " + chefFinalOrders.getItemQuantity());
