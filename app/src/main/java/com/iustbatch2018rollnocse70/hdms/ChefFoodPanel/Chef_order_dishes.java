...
public class Chef_order_dishes extends AppCompatActivity {
    ...
    private void Cheforderdishes() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("ShopkeeperPendingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Items");
