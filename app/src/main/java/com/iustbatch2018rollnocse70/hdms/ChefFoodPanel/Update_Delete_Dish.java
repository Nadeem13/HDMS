...
import com.iustbatch2018rollnocse70.hdms.ChefFoodPanel_BottomNavigation;
...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa = firebaseDatabase.getInstance().getReference("Shopkeeper").child(userid);
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                firebaseDatabase.getInstance().getReference("ItemSupplyDetails").child(State).child(City).child(Sub).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("ItemSupplyDetails").child(State).child(City).child(Sub).child(useridd).child(ID);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Dishname.setText("Dish name: " + updateDishModel.getItems());
                        dishes = updateDishModel.getItems();
                ...
                databaseReference = firebaseDatabase.getInstance().getReference("ItemSupplyDetails");
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("ItemSupplyDetails").child(State).child(City).child(Sub)
