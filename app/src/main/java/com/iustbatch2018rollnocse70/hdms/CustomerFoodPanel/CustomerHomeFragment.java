...
public class CustomerHomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void customermenu() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        databaseReference = FirebaseDatabase.getInstance().getReference("ItemSupplyDetails").child(State).child(City).child(Sub);
    ...
    private void search(final String searchtext) {
        ...
        for (UpdateDishModel object : updateDishModelList) {
            if (object.getItems().toLowerCase().contains(searchtext.toLowerCase())) {
                mylist.add(object);
            }
        }
