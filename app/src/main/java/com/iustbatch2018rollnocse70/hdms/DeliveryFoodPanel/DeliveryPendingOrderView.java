...
public class DeliveryPendingOrderView extends AppCompatActivity {
    ...
    private void deliveryorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Items");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ChefName.setText("Shopkeeper "+ deliveryShipOrders1.getShopkeeperName());
