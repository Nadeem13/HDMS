...
public class DeliveryPendingOrderViewAdapter extends RecyclerView.Adapter<DeliveryPendingOrderViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.dishname.setText(deliveryShipOrders.getItemName());
        holder.price.setText("Price: ₹ " + deliveryShipOrders.getItemPrice());
        holder.quantity.setText("× " + deliveryShipOrders.getItemQuantity());
