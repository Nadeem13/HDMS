...
public class DeliveryShipOrderView extends AppCompatActivity {
    ...
    private void deliveryfinalorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryShipFinalOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Items");
