...
public class DeliveryShipOrders {
    ...
    public DeliveryShipOrders(String shopkeeperId, String itemId, String itemName, String itemPrice, String itemQuantity, String randomUID, String totalPrice, String userId) {
